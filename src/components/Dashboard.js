...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <div className='tryyy p-3 grid grid-cols-5 gap-2 bg-[#DDDDDD]'>
        <div className='leftside h-[105vh] p-6  text-left'>
          <div className="bg-black h-[105%] w-[102%] m-auto rounded-3xl text-white p-4">
            <div className=" side mt-10 ml-4  h-[90%]">
        ...
        <div className='rightside col-span-4 p-4 '>
          <div className="w-[100%] text-left p-4 flex flex-row justify-between">
            <div><h1 className='font-bold text-xl'>Dashboard</h1></div>
            <div className=' flex flex-row  '>
              <div className='inputsearch flex mx-10'><input type="text" className='p-1 px-4 rounded-md' placeholder='Search' /><AiOutlineSearch className='-mx-8 my-2' /></div>
              <div className='flex'><MdNotificationsNone className='text-3xl mx-5 font-bold ' /></div>
              <div className=""><img src={img} className='rounded-xl' alt="" /></div>
            </div>
          </div>
          ...
          <div className=" my-4">
            <div className=" cards grid grid-cols-4 gap-10">
              <div className="card p-4 bg-[#DDEFE0] rounded-xl">
              ...
              <div className="card p-4 bg-[#F4ECDD] rounded-xl">
              ...
              <div className="card p-4 bg-[#EFDADA] rounded-xl">
              ...
              <div className="card p-4 bg-[#DEE0EF] rounded-xl">
          ...
          <div className="grid grid-cols-4 gap-6 ">
            <div className="line col-span-full border-2 h-[370px] bg-white text-left rounded-2xl">
              <div className=" p-6">
                ...
                <div className="py-6">
                  <Linechart className='linechart' data={userData} />
                </div>
              </div>
            </div>


            <div className="piegrid grid grid-cols-2 gap-5 col-span-full">

              <div className="pie h-[280px] w-[100%] bg-white rounded-2xl p-6">
                ...
                <div className='pieflex flex'>
                  <Piechart className='piechartwidth' data={pie} />
                  <div className='p-4'>
                    <div className='flex'>
